  ...
  return (
    <nav className=" bg-teal-500 p-6">
      <div className="wrapper flex items-center justify-between flex-wrap max-w-6xl m-auto">
        ...
        {menuOpen && <div className="lg:hidden w-full block lg:flex lg:items-center lg:w-auto transition-transform">
        ...
        <div className="hidden lg:block w-full block lg:flex lg:items-center lg:w-auto transition-transform">
          <div className="text-sm lg:flex-grow">
            <a href="/" className="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4">
              Home
            </a>
